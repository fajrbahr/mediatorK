...
class AboutTests {
    ...
    fun `should group students by enrollment date`() = runTest {
        fixture.createStudent(lastName = "A", enrollmentDate = "2025-01-01")
        fixture.createStudent(lastName = "B", enrollmentDate = "2025-01-01")
        fixture.createStudent(lastName = "C", enrollmentDate = "2025-06-01")
