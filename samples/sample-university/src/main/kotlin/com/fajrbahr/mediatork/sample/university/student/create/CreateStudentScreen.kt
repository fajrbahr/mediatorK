...
@Composable
fun CreateStudentScreen(viewModel: CreateStudentViewModel, onBack: () -> Unit) {
    ...
    Scaffold(
        ...
        Column(
            ...
            FormBlock(label = "First Name", value = state.firstMidName, onValueChange = viewModel::onFirstMidNameChange)
            FormBlock(
