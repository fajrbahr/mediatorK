 ...
 *
 * Unlike [Sender], publishing returns no value. When no handlers are registered for
 * the notification type, the configured [MissingNotificationHandler] is invoked —
 * by default [ThrowMissingNotificationHandler], which throws [MissingNotificationHandlerException].
