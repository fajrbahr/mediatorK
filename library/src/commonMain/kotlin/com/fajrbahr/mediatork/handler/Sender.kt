 ...
 * @see com.fajrbahr.mediatork.api.PipelineBehavior.Tag
 */
interface Sender {
    /**
     ...
     * 1. [com.fajrbahr.mediatork.api.PipelineBehavior.Tag.Pre] behaviors (sorted by order)
     * 2. [com.fajrbahr.mediatork.api.PipelineBehavior.Tag.Default] behaviors (sorted by order)
     * 3. [com.fajrbahr.mediatork.api.PipelineBehavior.Tag.Post] behaviors (sorted by order)
